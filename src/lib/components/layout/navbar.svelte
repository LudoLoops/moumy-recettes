...
<AppBar>
	<AppBar.Toolbar class="grid-cols-[1fr_auto_1fr]">
		<AppBar.Lead>
			<a href="/" class="text-white hover:text-primary-200-800 transition-colors" style="font-size: var(--text-logo); font-weight: var(--weight-title); font-family: var(--font-handwriting)">
